...
with DAG(dag_id='dynamic_task_mapping_mixed_operators',
    ...
    # What if you just want to collect the output of your mapped tasks into a classic
    # operator instead of using expand again?
    ...
    print_files = BashOperator(
        task_id='print_files',
        bash_command="echo '{{ ti.xcom_pull(task_ids='download_file', dag_id='dynamic_task_mapping_mixed_operators', key='return_value') | list }}'"
    )
